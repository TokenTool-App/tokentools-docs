...
自从shib火了以后，一级市场就出现了各种动物币，玩家也开始转战一级市场了，一级市场动不动就是几倍几十倍甚至上百倍行情，非常刺激。但是一级市场的币都是没有通过审核的，风险也极大。但是玩一级市场抢新币，需要一个好的工具——抢币科学家。项目一开盘就抢进去，赚取后期的丰厚利润。

## **TokenTools.App是什么？**

TokenTools.App本身是一个科学家网站，上面有很多非常牛逼的功能，比如批量创建钱包，批量空投，批量查询，代币归集，钱包授权解除等强大的功能。当然我今天要介绍的不是这些，而是针对一级市场火爆而设计的科学家抢币神器。最重要的是**免费！** **免费！** **免费！** 后期可能会收取一点服务器和劳务费用，现在是一直免费。
...
选择平台，我发现这个科学家抢币神器支持的平台很多，基本上市面上见到的主流的非主流的都支持，最近还新增加了马蹄链的quickswap等其他平台。

大家根据自己要抢的币的dex选择对应平台，这里演示，我选择了以太坊链的Rinkeby测试网，选择uniswap平台进行演示如何抢购。
...
载入私钥成功后，用户可以看到BNB或者HT或者OKT 余额，具体展示哪一种，和用户选择的交易平台属于哪个智能链有关。
...
合约地址：即该币种在Uniswap中的合约地址，本教程演示的是购买UNI测试币，地址`0xb1d1502fa0e5791c655b8e62e189335a25ebc8d4` 

提前授权：一般钱包里面没有币是不能提前授权的。使用科学家可以给没有的币提前授权，在卖出的时候就不用再次授权了。卖出速度更快，避免错过最佳卖出点位。

流动池：检测当前币种的交易对使用的是哪种配置。例如UNI-ETH交易对则选择ETH，不同币种的交易对不一样，如果不知道是什么交易对，则选择autoCheck自动检测机制。
...
如果代币管理员开启了暂停交易功能，则无法进行交易。此时可以开启失败重试功能，程序将会一直循环下单操作直到成功为止。

![create token](../.gitbook/assets/Snipaste_2021-10-24_23-15-25.png)

从交易记录可以看到，买入0.01ETH共5次，根据总花费和获得的UNI币数量，计算出平均价格为0.010425074494342828。
