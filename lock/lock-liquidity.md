...
导航到 [https://tokentools.app/lock/liquidity](https://tokentools.app/lock/liquidity) 并按照以下简单步骤进行操作：

1. 链接你的钱包。
2. 前往[https://tokentools.app/lock/liquidity](https://tokentools.app/lock/liquidity)
3. 查看当前地址锁池子列表数据，可以看到（锁定时间与解锁时间，明细信息，延迟解锁操作等）

![lock-token](../.gitbook/assets/lock/Snipaste_2022-11-26_12-16-37.png)

查看明细信息，可以看到很多解锁的明细数据，如果代币是分批解锁的，则会显示多次解锁的明细数据。
...
2. 点击"确认"
3. MetaMask现在会要求您确认交易。它还将显示您需要为该交易支付的费用。如果您同意，则单击”确认”按钮以完成”延迟时间”过程。
...
1. 当时间到达设置的解锁时间后，可以通过提取按钮，提取代币或池子LP
2. 点击提取
3. MetaMask现在会要求您确认交易。它还将显示您需要为该交易支付的费用。如果您同意，则单击”确认”按钮以完成”提取解锁”过程。
