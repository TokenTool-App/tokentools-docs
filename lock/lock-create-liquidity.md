...
导航到 [https://tokentools.app/lock/create](https://tokentools.app/lock/create) 并按照以下简单步骤进行操作：

1. 链接你的钱包。
2. 前往[https://tokentools.app/lock/create](https://tokentools.app/lock/create)
3. 输入您的流动性令牌合约地址后，页面将显示您的代币池子信息与余额（如图中所示的 TTT-WBNB 交易对、交易所及余额等信息）。
...
9. MetaMask现在会要求您确认交易。它还将显示您需要为该交易支付的费用。如果您同意，则单击”确认”按钮以完成”锁定”过程。
...
如果您的代币合约有LP分红，或者持LP奖励等机制，一定要将锁仓合约地址排除在外的操作。

请排除TokenToolLock 的锁仓合约地址，您可以在黄色提示中看到 TokenToolLock 的锁仓合约地址。
