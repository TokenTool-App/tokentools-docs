...
> **TokenTools是一个区块链工具箱，支持TRX、ETH、BSC等超多公链，可以创建多种不同机制模型代币，轻松解决发币问题，可在几分钟内创建一个属于你自己的Token。**
...
**初始供应量：** 代币的总供应量（精度18位时，总供应量可以是1后面加15个0，精度17位时，总供应量可以是1后面加16个0，以此类推……）

**精度：** 代币的精度位数（精度是代表币的小数位数`如：0.000001`代表有6位精度）
